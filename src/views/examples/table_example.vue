<template>
  <div class="page_content">
    ...
    <article>
      ...
      <!--      :export-config="{remote:true,filename:'测试表格',sheetName:'sheet1',type:'xlsx',mode:'all',modes:['current','selected','all'],exportMethod:exportMethod}"-->
